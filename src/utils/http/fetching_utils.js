...
export const get = (url) => {
  return new Promise((resolve, reject) => {
    axiosInstance.get(_handleUrl(url))
      .then((res) => resolve(res.data))
      .catch((err) => { reject(err && err.response ? err.response.data : err); });
  });
}
...
export const post = (url, body) => {
  return new Promise((resolve, reject) => {
    axiosInstance.post(_handleUrl(url), body)
      .then((res) => resolve(res.data))
      .catch((err) => { reject(err && err.response ? err.response.data : err) });
  });
}
...
export const del = (url) => {
  return new Promise((resolve, reject) => {
    axiosInstance.delete(_handleUrl(url))
      .then((res) => resolve(res.data))
      .catch((err) => { reject(err && err.response ? err.response.data : err) })
  });
}