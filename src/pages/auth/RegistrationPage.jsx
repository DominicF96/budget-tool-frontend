...
const RegistrationPage = ({ intl }) => {
  ...
  const [pageOpenedAt, setPageOpenedAt] = useState(moment());
    ...
    <div className="container-fluid fade-in" id="registration_page">
      ...
      <Form>
        ...
        <Form.Group>
          ...
          <Form.Control
            type="text"
            placeholder={intl.formatMessage({ id: "generic.fields.firstname" })}
            className="mt-3"
            onChange={(e) => updateData("firstname", e.target.value)}
          />
          <Form.Control
            type="text"
            placeholder={intl.formatMessage({ id: "generic.fields.lastname" })}
            className="mt-3"
          ...
          <Form.Control
            ...
            placeholder={intl.formatMessage({ id: "generic.fields.email" })}
            className="mt-3"
            onChange={(e) => updateData("email", e.target.value)}
          />
          <Form.Control
            as="select"
            placeholder={intl.formatMessage({ id: "generic.fields.sex" })}
            className="mt-3"
